...
\begin{axis}[
    ...
    xmin=0,
    ymax=0.4,
    xtick={7200, 14400, 21600, 28800, 36000, 43299},
    xticklabels={2h, 4h, 6h, 8h, 10h, 12h},
    scaled ticks=false,
    %samples=500,
    axis lines=middle,
...
\addplot [ybar, color=blue, fill=blue!50] table[x index=0, y index=1]{pipeline-total-hist.dat};
